...
public class Point implements Comparable<Point> {
    ...
    private class SlopeOrder implements Comparator<Point> {
        ...
        public int compare(Point q1, Point q2) {
            return Double.compare(Point.this.slopeTo(q1), Point.this.slopeTo(q2));
    ...
    public static void main(String[] args) {
        ...
        /* test if compareTo works properly
        Point p = new Point(5, 5);
        System.out.println(p.compareTo(new Point(5, 6)));
        */

        /* test if slopeTo works
        Point p = new Point(5, 5);
        System.out.println(p.slopeTo(new Point(7, 6)));
